...
(function() {
  var fte, hardware, outsource, software;

  $(function($) {
    return $('#form_calc').live("ajax:complete", function(xhr) {}).live("ajax:beforeSend", function(xhr) {
      return $('#result').html('<div>Loading...</div>');
    }).live("ajax:success", function(event, data, status, xhr) {
      var output_html, total1, total2, _ref;
      output_html = "";
      _ref = hardware(data['hw']), output_html = _ref[0], total1 = _ref[1], total2 = _ref[2];
  ...
  hardware = function(data) {
    ...
    html += "</td></tr>";
    html += "</table>";
    return [html, total1, total2];
  };

  software = function(data, n1, n2) {
    var html, o, _i, _len;
    html = "<table id='result_tbl' class='result_tbl'>";
